...
class StrorageWindow(ToplevelPattern):
    ...
    def create_widgets(self):
        ...
        self.create_entry(self.frame_left, "Lagerort hinzufügen", 1, 1)
        self.create_label(self.frame_left,"Hier sollte die Treeauswahl stehen", 2, 1, width=30)

        tree_headings= ["Lagerort"]
        self.create_tree(self.frame_right, tree_headings, 1, 1, 500)

        self.create_button(self.frame_bottom, "Lagerort hinzufügen", 1, 1, self.do_nothing)
